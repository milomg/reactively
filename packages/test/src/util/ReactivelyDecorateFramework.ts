...
@hasReactive
class Sources implements HasSources {
...
@hasReactive
class ComputeLayer implements HasSources {
  source: HasSources;
  layerNumber: number;
  counter: Counter;
...
const width = 10; // set to 2 debug a smaller graph

export function staticDecorateGraph(totalLayers: number): GraphAndCounter {
